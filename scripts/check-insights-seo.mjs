...
const certifiedPageRequired = [
  ...recoveryAssuredPageRequired,
  "Assured is not certified",
  "a third-party or internal program stamp that a recovery/continuity program exists or once met a named checklist",
  "ISO/SOC/DR cert, annual auditor letter, laminated \"certified recoverable\" badge",
  "not the same as re-proving restore under today’s named owner inside the named window with evidence continuity intact",
  "A firm can be assured and still not certified",
  "dated owner-side re-prove of restore in window, no external stamp",
  "A firm can chase certification theater and still not be assured",
  "annual DR certificate while the restore path has not been re-broken and re-proven under the current owner inside the named window",
  "A certificate alone is not assurance",
  "An assurance record alone is not certification",
  ...
  "Sync does not measure certification for the customer",
  "Sync does not measure assurance or certification for the customer",
  "Sync must not auto-issue certificates",
  "Sync must not auto-transfer ownership, auto-declare RTO met, auto-credit Learning for an unrecovered handoff, auto-issue assurance, or auto-issue certificates",
  "Sync may surface an assurance record or a certification stamp",
  "does not collapse certification into assurance",
  ...
  "assured as certified",
  "separates a dated assurance record from a certification stamp",
  "/insights/recoverable-is-not-assured",
  "Evidence from the plant beats the assurance record when the record is being used as certification",
  "Evidence from the plant beats the certificate when the certificate is being used as assurance",
...
const certifiedPage = read('app/insights/assured-is-not-certified/page.tsx');
for (const required of certifiedPageRequired) {
  if (!certifiedPage.includes(required)) {
    fail(`assured-is-not-certified page must include ${required}`);
  }
}
...
for (const slug of [
  ...
  if (!stepBlock(slug).includes('assured-is-not-certified')) {
    fail(`${slug} related reading must cite assured-is-not-certified`);
  }
}

const certifiedBlock = stepBlock('assured-is-not-certified');
for (const required of ['recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!certifiedBlock.includes(`'${required}'`)) {
    fail(`assured-is-not-certified related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(certifiedBlock)) {
  fail('assured-is-not-certified related reading must include the Strategic Pilot');
}
if (certifiedBlock.includes("next: 'strategic-pilot'")) {
  fail('assured-is-not-certified next step is the Field Manual');
}

if (
  !recoveryAssuredPage.includes('The series continues with') ||
  !recoveryAssuredPage.includes('/insights/assured-is-not-certified')
) {
  fail('recoverable-is-not-assured must point the series forward to assured-is-not-certified');
}


const insuredPageRequired = [
  ...certifiedPageRequired,
  "Certified is not insured",
  "a named, in-force indemnity/coverage instrument (policy, binder, endorsement, named insured + limits + triggers + exclusions + claims path) that actually responds when recovery fails or loss lands",
  "not a certificate PDF, not a sales claim that \"we’re covered,\" and not a CMMS checkbox",
  "not the same as risk transfer that pays when restore fails under today’s named owner inside the named window",
  "A firm can be certified and still not insured",
  "program stamp on file, no in-force policy that responds to the named restore/continuity failure",
  "A firm can be insured and still not certified",
  "in-force coverage that would pay, no ISO/SOC/DR stamp",
  "A certificate alone is not insurance",
  "A policy alone is not certification",
  ...
  "Sync does not measure insurance for the customer",
  "Sync does not measure certification or insurance for the customer",
  "Sync must not auto-issue policies",
  "Sync must not auto-transfer ownership, auto-declare RTO met, auto-credit Learning for an unrecovered handoff, auto-issue assurance, auto-issue certificates, or auto-issue policies",
  "Sync may surface a certification stamp or an insurance instrument",
  "does not collapse insurance into certification",
  ...
  "certified as insured",
  "separates a certification stamp from an in-force coverage instrument",
  "/insights/assured-is-not-certified",
  "Evidence from the plant beats the certificate when the certificate is being used as insurance",
  "Evidence from the plant beats the policy when the policy is being used as certification",
  "treat certified as insured as Learning credit",
  "Sync refuses to pretend certification or insurance is a status light",
  "Direct plant execute stays off",
  "CMMS write-back is not a live product path",
  "Billing write-back is not a live product path",
  "Evidence lineage is not optional",
...
const insuredPage = read('app/insights/certified-is-not-insured/page.tsx');
for (const required of insuredPageRequired) {
  if (!insuredPage.includes(required)) {
    fail(`certified-is-not-insured page must include ${required}`);
  }
}
...
for (const slug of [
  ...
  if (!stepBlock(slug).includes('certified-is-not-insured')) {
    fail(`${slug} related reading must cite certified-is-not-insured`);
  }
}

const insuredBlock = stepBlock('certified-is-not-insured');
for (const required of ['assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!insuredBlock.includes(`'${required}'`)) {
    fail(`certified-is-not-insured related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(insuredBlock)) {
  fail('certified-is-not-insured related reading must include the Strategic Pilot');
}
if (insuredBlock.includes("next: 'strategic-pilot'")) {
  fail('certified-is-not-insured next step is the Field Manual');
}

if (
  !certifiedPage.includes('The series continues with') ||
  !certifiedPage.includes('/insights/certified-is-not-insured')
) {
  fail('assured-is-not-certified must point the series forward to certified-is-not-insured');
}

const coveredPageRequired = [
  ...insuredPageRequired,
  "Insured is not covered",
  "a named, in-force indemnity/coverage instrument exists (policy, binder, endorsement, named insured + limits + triggers + exclusions + claims path on file)",
  "not the same as the specific restore/continuity/loss event actually falling inside that instrument’s responding terms today",
  "the named failure, loss, location, asset class, cause, and window are inside the policy’s responding grant of coverage (triggers met, exclusions not barring, named insured correct, limits not exhausted, notice conditions satisfiable)",
  "not \"we have a policy,\" not a certificate of insurance PDF, not a broker email saying \"you’re good,\" and not a CMMS checkbox",
  "A firm can be insured and still not covered",
  "policy in force; this restore failure / flood / cyber / downtime cause is excluded, sublimited, misnamed, or outside the period",
  "A firm can be covered for a named event class and still not insured",
  "coverage language exists in a draft or quote, no in-force binder",
  "A policy alone is not coverage for this event",
  "Coverage language alone is not an in-force policy",
  ...
  "Sync does not measure coverage for the customer",
  "Sync does not measure insurance or coverage for the customer",
  "Sync must not auto-adjudicate claims",
  "Sync must not auto-transfer ownership, auto-declare RTO met, auto-credit Learning for an unrecovered handoff, auto-issue assurance, auto-issue certificates, auto-issue policies, or auto-adjudicate claims",
  "Sync may surface an insurance instrument or a coverage determination",
  "does not collapse coverage into insurance",
  "does not collapse insured into covered",
  "does not rewrite Certified Is Not Insured",
  "does not collapse into Certified Is Not Insured",
  "does not collapse into Verified Is Not Assured",
  "does not rewrite Verified Is Not Assured",
  "practice record that says insured is covered",
  "insured as covered",
  "separates an in-force coverage instrument from a responding grant of coverage for this event",
  "/insights/certified-is-not-insured",
  "Evidence from the plant beats the policy when the policy is being used as coverage for this event",
  "Evidence from the plant beats the coverage language when the language is being used as an in-force policy",
  "treat insured as covered as Learning credit",
  "Sync refuses to pretend insurance or coverage is a status light",
  "Direct plant execute stays off",
  "CMMS write-back is not a live product path",
  "Billing write-back is not a live product path",
  "Evidence lineage is not optional",
...
const coveredPage = read('app/insights/insured-is-not-covered/page.tsx');
for (const required of coveredPageRequired) {
  if (!coveredPage.includes(required)) {
    fail(`insured-is-not-covered page must include ${required}`);
  }
}
...
for (const slug of [
  ...
  if (!stepBlock(slug).includes('insured-is-not-covered')) {
    fail(`${slug} related reading must cite insured-is-not-covered`);
  }
}

const coveredBlock = stepBlock('insured-is-not-covered');
for (const required of ['certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!coveredBlock.includes(`'${required}'`)) {
    fail(`insured-is-not-covered related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(coveredBlock)) {
  fail('insured-is-not-covered related reading must include the Strategic Pilot');
}
if (coveredBlock.includes("next: 'strategic-pilot'")) {
  fail('insured-is-not-covered next step is the Field Manual');
}

if (
  !insuredPage.includes('The series continues with') ||
...
const settledPageRequired = [
  ...paidPageRequired,
  "Paid is not settled",
  "the named claim/event is finally closed with a written release (or equivalent finality instrument) that ends open reserve, binds the named parties on that loss window, and leaves no open adjudication path for that same named event under today’s owner",
  "not \"a check cleared,\" not a partial payment, not a reserve reduced to zero without release, and not a CMMS checkbox",
  "A firm can be paid and still not settled",
  "funds moved or payment scheduled; claim still open, release unsigned, subrogation open, or reserve still live",
  "A firm can chase settlement theater and still not be paid",
  "release draft or \"agreed in principle\" while no funds have moved and no binding payment date/amount is trackable",
  "A payment alone is not settlement finality",
  "A settlement instrument alone is not proof funds moved",
  ...
  "Sync does not measure settlement for the customer",
  "Sync does not measure payment or settlement for the customer",
  "Sync may surface a payment record or a settlement status",
  "does not collapse settlement into payment",
  ...
  "paid as settled",
  "separates indemnity that has actually moved from a written release that ends the named claim",
  "/insights/covered-is-not-paid",
  "Evidence from the plant beats the payment record when the record is being used as settlement",
  "Evidence from the plant beats the settlement instrument when the instrument is being used as proof funds moved",
  "treat paid as settled as Learning credit",
  "Sync refuses to pretend payment or settlement is a status light",
  "Sync does not pay for the customer",
  "Sync does not settle claims for the customer",
  "Direct plant execute stays off",
  "CMMS write-back is not a live product path",
  ...
  "Recommend is not authorize",
  "does not rewrite Insured Is Not Covered",
  "Sync does not adjudicate claims for the customer",
  "Sync must not auto-pay",
  "Sync must not auto-settle",
];
const settledPage = read('app/insights/paid-is-not-settled/page.tsx');
for (const required of settledPageRequired) {
  if (!settledPage.includes(required)) {
    fail(`paid-is-not-settled page must include ${required}`);
  }
}
...
for (const slug of [
  ...
  if (!stepBlock(slug).includes('paid-is-not-settled')) {
    fail(`${slug} related reading must cite paid-is-not-settled`);
  }
}

const settledBlock = stepBlock('paid-is-not-settled');
for (const required of ['covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!settledBlock.includes(`'${required}'`)) {
    fail(`paid-is-not-settled related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(settledBlock)) {
  fail('paid-is-not-settled related reading must include the Strategic Pilot');
}
if (settledBlock.includes("next: 'strategic-pilot'")) {
  fail('paid-is-not-settled next step is the Field Manual');
}

if (
  !paidPage.includes('The series continues with') ||
  !paidPage.includes('/insights/paid-is-not-settled')
) {
  fail('covered-is-not-paid must point the series forward to paid-is-not-settled');
}

const bookedPageRequired = [
  ...settledPageRequired,
  "Settled is not booked",
  "the indemnity / recovery / settlement amount is recognized on the named entity’s financials for a named period and account (GL / AR / cash ledger entry that a controller can point to), with amount, date, and counterparty trackable",
  "not a release PDF in a folder, not a bank credit alone without a GL post, not a dashboard tile, and not \"we’ll book it at month-end\" without a posted entry",
  "A firm can be settled and still not booked",
  "release signed; no GL/AR recognition for that named amount/period",
  "A firm can chase booking theater and still not be settled",
  "accrual or estimate posted while release unsigned, reserve live, or adjudication still open",
  "A settlement instrument alone is not a booked financial recognition",
  "A ledger line alone is not proof the named claim is settled",
  ...
  "Sync does not measure booking for the customer",
  "Sync does not measure settlement or booking for the customer",
  "Sync may surface a settlement status or a ledger entry",
  "does not collapse booking into settlement",
  ...
  "settled as booked",
  "separates a written release that ends the named claim from a ledger entry that recognizes the named amount",
  "/insights/paid-is-not-settled",
  "Evidence from the plant beats the settlement status when the status is being used as booking",
  "Evidence from the plant beats the ledger entry when the entry is being used as proof the named claim is settled",
  "treat settled as booked as Learning credit",
  "Sync refuses to pretend settlement or booking is a status light",
  "Sync does not book for the customer",
...
const bookedPage = read('app/insights/settled-is-not-booked/page.tsx');
for (const required of bookedPageRequired) {
  if (!bookedPage.includes(required)) {
    fail(`settled-is-not-booked page must include ${required}`);
  }
}

const bookedBlock = stepBlock('settled-is-not-booked');
for (const required of ['paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!bookedBlock.includes(`'${required}'`)) {
    fail(`settled-is-not-booked related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(bookedBlock)) {
  fail('settled-is-not-booked related reading must include the Strategic Pilot');
}
if (bookedBlock.includes("next: 'strategic-pilot'")) {
  fail('settled-is-not-booked next step is the Field Manual');
}
if (!stepBlock('paid-is-not-settled').includes("'settled-is-not-booked'")) {
  fail('paid-is-not-settled related reading must point forward to settled-is-not-booked');
}

if (
  !settledPage.includes('The series continues with') ||
  !settledPage.includes('/insights/settled-is-not-booked')
) {
  fail('paid-is-not-settled must point the series forward to settled-is-not-booked');
}

const reconciledPageRequired = [
  ...bookedPageRequired,
  ...
  "entry posted; bank/subledger/counterparty evidence does not match or the trail is unbroken only in a slide",
  "A firm can chase reconciliation theater and still not be booked",
  "worksheet or bank match story while no GL/AR recognition exists for that named amount/period",
  "A ledger line alone is not a signed reconciliation",
  "A reconciliation worksheet alone is not proof the named amount is booked",
  ...
  "Sync does not measure reconciliation for the customer",
  "Sync does not measure booking or reconciliation for the customer",
  "Sync may surface a ledger entry or a reconciliation trail",
  "does not collapse reconciliation into booking",
  ...
  "booked as reconciled",
  "separates a ledger entry that recognizes the named amount from a signed reconciliation trail that matches the supporting evidence",
  "/insights/settled-is-not-booked",
  "Evidence from the plant beats the ledger entry when the entry is being used as reconciliation",
  "Evidence from the plant beats the reconciliation worksheet when the worksheet is being used as proof the named amount is booked",
  "treat booked as reconciled as Learning credit",
  "Sync refuses to pretend booking or reconciliation is a status light",
...
const reconciledPage = read('app/insights/booked-is-not-reconciled/page.tsx');
for (const required of reconciledPageRequired) {
  if (!reconciledPage.includes(required)) {
    fail(`booked-is-not-reconciled page must include ${required}`);
  }
}

const reconciledBlock = stepBlock('booked-is-not-reconciled');
for (const required of ['settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!reconciledBlock.includes(`'${required}'`)) {
    fail(`booked-is-not-reconciled related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(reconciledBlock)) {
  fail('booked-is-not-reconciled related reading must include the Strategic Pilot');
}
if (reconciledBlock.includes("next: 'strategic-pilot'")) {
  fail('booked-is-not-reconciled next step is the Field Manual');
}
if (!stepBlock('settled-is-not-booked').includes("'booked-is-not-reconciled'")) {
  fail('settled-is-not-booked related reading must point forward to booked-is-not-reconciled');
}

if (
  !bookedPage.includes('The series continues with') ||
  !bookedPage.includes('/insights/booked-is-not-reconciled')
) {
...
const closedCollectedPageRequired = [
  ...periodClosedPageRequired,
  "Closed Is Not Collected",
  "Closed is not collected",
  "cash for that named closed receivable / invoice / obligation has actually hit the named bank account (or named cleared settlement rail) in the named amount and currency, with a payment application trail tying the cash to the named closed item — not an AR aging green, not \"customer said they paid,\" not a close attestation alone, not a remittance advice without bank evidence, and not a CMMS checkbox",
  "not an AR aging green, not \"customer said they paid,\" not a close attestation alone, not a remittance advice without bank evidence, and not a CMMS checkbox",
  "A firm can be closed and still not collected",
  "period attestation locked while named AR cash has not cleared",
  "A firm can chase collection theater and still not be closed",
  "payment chase while cut-off / close attestation not locked",
  "A close attestation alone is not proof the named amount is collected",
  "A bank deposit alone is not a period close",
  ...
  "Sync does not measure collection for the customer",
  "Sync does not measure close or collection for the customer",
  "Sync may surface a close attestation or a collection record",
  "does not collapse collection into close",
  ...
  "closed as collected",
  "separates a period close a named controller or CFO can attest from cash that has actually hit the named bank account for that named closed item",
  "/insights/reconciled-is-not-closed",
  "Evidence from the plant beats the close attestation when the attestation is being used as collection",
  "Evidence from the plant beats the collection record when the record is being used as proof the period is closed",
  "treat closed as collected as Learning credit",
  "Sync refuses to pretend close or collection is a status light",
...
const closedCollectedPage = read('app/insights/closed-is-not-collected/page.tsx');
for (const required of closedCollectedPageRequired) {
  if (!closedCollectedPage.includes(required)) {
    fail(`closed-is-not-collected page must include ${required}`);
  }
}

const closedCollectedBlock = stepBlock('closed-is-not-collected');
for (const required of ['reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!closedCollectedBlock.includes(`'${required}'`)) {
    fail(`closed-is-not-collected related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(closedCollectedBlock)) {
  fail('closed-is-not-collected related reading must include the Strategic Pilot');
}
if (closedCollectedBlock.includes("next: 'strategic-pilot'")) {
  fail('closed-is-not-collected next step is the Field Manual');
}
if (!stepBlock('reconciled-is-not-closed').includes("'closed-is-not-collected'")) {
  fail('reconciled-is-not-closed related reading must point forward to closed-is-not-collected');
}

if (
  !periodClosedPage.includes('The series continues with') ||
  !periodClosedPage.includes('/insights/closed-is-not-collected')
) {
...
const reportedPageRequired = [
  ...recognizedPageRequired,
  "Recognized Is Not Reported",
  "Recognized is not reported",
  "that named recognized amount appears in the named period report pack (management pack / board pack / statutory / lender pack as applicable) for the named entity with the named line, period, and preparer/attester, reconcilable to the recognition evidence",
  "not a slide that restates cash, not a CMMS KPI tile, not a one-off spreadsheet export, not \"finance said it’s in the books,\" and not a status light",
  "A firm can be recognized and still not reported",
  "earning attested while the named pack omits, mislines, or cannot reconcile the amount",
  "A firm can chase reporting theater and still not be recognized",
  "a pack or dashboard shows revenue while the named earning / acceptance rule is not met or attested",
  "A recognition journal alone is not a period report",
  "A report line alone is not proof the named amount is recognized",
  ...
  "Sync does not measure reporting",
  "Sync does not measure reporting for the customer",
  "Sync does not measure recognition or reporting for the customer",
  "Sync may surface a recognition attestation or a report record",
  "does not collapse reporting into recognition",
  "does not collapse recognized into reported",
  "does not rewrite Collected Is Not Recognized",
  "does not collapse into Collected Is Not Recognized",
  "practice record that says recognized is reported",
  "recognized as reported",
  "separates earned revenue recognized under the named acceptance / milestone / performance obligation rule from that named recognized amount in the named period report pack",
  "/insights/collected-is-not-recognized",
  "Evidence from the plant beats the recognition attestation when the attestation is being used as reporting",
  "Evidence from the plant beats the report record when the record is being used as proof the named amount is recognized",
  "treat recognized as reported as Learning credit",
  "Sync refuses to pretend recognition or reporting is a status light",
  "Sync does not report revenue for the customer",
  ...
  "False confidence here is a recognition journal treated as the period report",
...
const reportedPage = read('app/insights/recognized-is-not-reported/page.tsx');
for (const required of reportedPageRequired) {
  if (!reportedPage.includes(required)) {
    fail(`recognized-is-not-reported page must include ${required}`);
  }
}

const reportedBlock = stepBlock('recognized-is-not-reported');
for (const required of ['collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!reportedBlock.includes(`'${required}'`)) {
    fail(`recognized-is-not-reported related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(reportedBlock)) {
  fail('recognized-is-not-reported related reading must include the Strategic Pilot');
}
if (reportedBlock.includes("next: 'strategic-pilot'")) {
  fail('recognized-is-not-reported next step is the Field Manual');
}
if (!stepBlock('collected-is-not-recognized').includes("'recognized-is-not-reported'")) {
  fail('collected-is-not-recognized related reading must point forward to recognized-is-not-reported');
}

if (
  !recognizedPage.includes('The series continues with') ||
  !recognizedPage.includes('/insights/recognized-is-not-reported')
) {
  fail('collected-is-not-recognized must point the series forward to recognized-is-not-reported');
}


const auditedPageRequired = [
  ...reportedPageRequired,
  ...
  "A firm can be reported and still not audited",
  "pack line and preparer/attester exist while no independent opinion covers that period/entity/line",
  "A firm can chase audit theater and still not be reported",
  "an opinion or readiness claim exists while the named recognized amount is omitted, mislined, or not reconcilable in the named pack",
  "A report pack alone is not an audit opinion",
  "An audit opinion alone is not proof the named amount is reported in the pack",
  ...
  "Sync does not measure auditing for the customer",
  "Sync does not measure reporting or auditing for the customer",
  "Sync may surface a report record or an audit opinion",
  "does not collapse auditing into reporting",
  "does not collapse reported into audited",
  "does not rewrite Recognized Is Not Reported",
  "does not collapse into Recognized Is Not Reported",
  "practice record that says reported is audited",
  "reported as audited",
  "separates that named recognized amount in the named period report pack from an independent named opinion or assurance conclusion",
  "/insights/recognized-is-not-reported",
  "Evidence from the plant beats the report record when the record is being used as an audit",
  "Evidence from the plant beats the audit opinion when the opinion is being used as proof the named amount is reported",
  "treat reported as audited as Learning credit",
  "Sync refuses to pretend reporting or audit is a status light",
  ...
  "work-order / incident closed",
  "period/books close",
  "Keep recognized (earning attested under the named acceptance rule) from Recognized Is Not Reported distinct from reported and from audited",
  "False confidence here is a report pack treated as an audit opinion",
  "Field proof is the named trail, not the tile",
  "What changes Tuesday is the refusal to let one record wear the other record’s name",
];
const auditedPage = read('app/insights/reported-is-not-audited/page.tsx');
for (const required of auditedPageRequired) {
  if (!auditedPage.includes(required)) {
    fail(`reported-is-not-audited page must include ${required}`);
  }
}

const auditedBlock = stepBlock('reported-is-not-audited');
for (const required of ['recognized-is-not-reported', 'collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!auditedBlock.includes(`'${required}'`)) {
    fail(`reported-is-not-audited related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(auditedBlock)) {
  fail('reported-is-not-audited related reading must include the Strategic Pilot');
}
if (auditedBlock.includes("next: 'strategic-pilot'")) {
  fail('reported-is-not-audited next step is the Field Manual');
}
if (!stepBlock('recognized-is-not-reported').includes("'reported-is-not-audited'")) {
  fail('recognized-is-not-reported related reading must point forward to reported-is-not-audited');
}

if (
  !reportedPage.includes('The series continues with') ||
...
const postedPageRequired = [
  ...acceptedFilingPageRequired,
  "Accepted Is Not Posted",
  "Accepted is not posted",
  "that same accepted filing has been published / made available on the named public disclosure system or registry of record for that channel (e.g. SEDAR+/EDGAR/equivalent lender portal public packet / board minutes repository as applicable), with a named posting identifier / URL / accession and posting timestamp, and an unbroken trail from that public posting back to the acceptance notice and filing receipt",
  "not an internal share link, not a draft upload sitting in a private folder, not an email attachment, not \"we sent it to the portal,\" not a dashboard green, and not a CMMS checkbox",
  "A firm can be accepted and still not posted",
  "acceptance/completeness acknowledgement exists while no named public posting/accession for that filing",
  "A firm can chase posting theater and still not be accepted",
  "a public-looking URL or draft portal entry exists while no named acceptance for that entity/period/channel",
  "An acceptance notice alone is not a public posting",
  "A public URL alone is not proof of acceptance under the named filing trail",
  ...
  "Sync does not measure posting for the customer",
  "Sync does not measure acceptance or posting for the customer",
  "Sync may surface an acceptance notice or a public posting",
  "does not collapse posting into acceptance",
  "does not collapse accepted into posted",
  ...
  "distinct from Complete Is Not Accepted",
  "practice record that says accepted is posted",
  "accepted as posted",
  "separates a named acceptance or completeness acknowledgement from a named public posting",
  "/insights/filed-is-not-accepted",
  "Evidence from the plant beats the acceptance notice when the notice is being used as posting",
  "Evidence from the plant beats the public posting when the posting is being used as proof of acceptance under the named filing trail",
  "treat accepted as posted as Learning credit",
  "Sync refuses to pretend acceptance or posting is a status light",
  "Sync does not post for the customer",
  ...
  "Sync must not auto-collect",
  "Sync must not auto-close-books",
  "Keep filed (named lodging receipt) from Filed Is Not Accepted, audited (independent named opinion) from Audited Is Not Filed, and reported from Reported Is Not Audited, distinct from accepted and from posted",
  "False confidence here is an acceptance notice treated as a public posting, or a public URL treated as proof of acceptance under the named filing trail.",
  "Field proof is the named trail, not the tile.",
  "What changes Tuesday is the refusal to let one record wear the other record’s name.",
  "Direct plant execute stays off",
  "CMMS write-back is not a live product path",
...
const postedPage = read('app/insights/accepted-is-not-posted/page.tsx');
for (const required of postedPageRequired) {
  if (!postedPage.includes(required)) {
    fail(`accepted-is-not-posted page must include ${required}`);
  }
}

const postedBlock = stepBlock('accepted-is-not-posted');
for (const required of ['filed-is-not-accepted', 'audited-is-not-filed', 'reported-is-not-audited', 'recognized-is-not-reported', 'collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!postedBlock.includes(`'${required}'`)) {
    fail(`accepted-is-not-posted related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(postedBlock)) {
  fail('accepted-is-not-posted related reading must include the Strategic Pilot');
}
if (postedBlock.includes("next: 'strategic-pilot'")) {
  fail('accepted-is-not-posted next step is the Field Manual');
}
if (!stepBlock('filed-is-not-accepted').includes("'accepted-is-not-posted'")) {
  fail('filed-is-not-accepted related reading must point forward to accepted-is-not-posted');
}

if (
  !acceptedFilingPage.includes('The series continues with') ||
  !acceptedFilingPage.includes('/insights/accepted-is-not-posted')
) {
...
const bindingPageRequired = [
  ...effectivePageRequired,
  "Effective Is Not Binding",
  "Effective is not binding",
  "under the named rule / instrument / board resolution / lender covenant / statute for that channel, that posted filing has reached its named legal or operational effective date and named scope (who it binds, from when, for which entity/period/obligation), with an unbroken evidence trail from that effectiveness claim back to the posting accession and the named effectiveness rule — not the posting timestamp alone, not \"it’s on SEDAR so it counts,\" not a dashboard green, not a CMMS checkbox, and not treating accession as automatic legal effect",
  "not the effective date alone, not \"it’s effective so they’re bound,\" not a dashboard green, not a CMMS checkbox, and not treating effectiveness as automatic enforceability",
  "A firm can be effective and still not binding",
  "named effective date/scope reached while required bind/notice/counterpart evidence is missing",
  "A firm can chase binding theater and still not be effective",
  "everyone is bound / we’re enforcing",
  "An effectiveness date alone is not binding force",
  "A binding claim alone is not proof of named effectiveness under the posted filing trail",
  ...
  "Sync does not measure effectiveness or binding for the customer",
  "Sync may surface an effectiveness record or a binding record",
  "does not collapse binding into effectiveness",
  "does not collapse effective into binding",
  ...
  "public registry/disclosure posting of that accepted filing",
  "named legal/operational effectiveness under the instrument for that posted filing",
  "instrument-required bind mechanics / enforceable obligation evidence for that effective filing",
  "distinct from Complete Is Not Accepted",
  "practice record that says effective is binding",
  "effective as binding",
  "separates a named effectiveness date and named scope from",
  "/insights/posted-is-not-effective",
  "Evidence from the plant beats the effectiveness record when the record is being used as binding",
  "Evidence from the plant beats the binding claim when the claim is being used as proof of named effectiveness under the posted filing trail",
  "treat effective as binding as Learning credit",
  "Sync refuses to pretend effectiveness or binding is a status light",
  ...
  "Sync must not auto-collect",
  "Sync must not auto-close-books",
  "Keep posted (public registry/disclosure posting) from Posted Is Not Effective, accepted from Accepted Is Not Posted, filed from Filed Is Not Accepted, audited from Audited Is Not Filed, and reported from Reported Is Not Audited, distinct from effective and from binding.",
  "False confidence here is an effectiveness date treated as binding force, or a binding claim treated as proof of named effectiveness under the posted filing trail.",
  "Field proof is the named trail, not the tile.",
  "What changes Tuesday is the refusal to let one record wear the other record’s name.",
  "Direct plant execute stays off",
  "CMMS write-back is not a live product path",
...
const bindingPage = read('app/insights/effective-is-not-binding/page.tsx');
for (const required of bindingPageRequired) {
  if (!bindingPage.includes(required)) {
    fail(`effective-is-not-binding page must include ${required}`);
  }
}

const bindingBlock = stepBlock('effective-is-not-binding');
for (const required of ['posted-is-not-effective', 'accepted-is-not-posted', 'filed-is-not-accepted', 'audited-is-not-filed', 'reported-is-not-audited', 'recognized-is-not-reported', 'collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!bindingBlock.includes(`'${required}'`)) {
    fail(`effective-is-not-binding related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(bindingBlock)) {
  fail('effective-is-not-binding related reading must include the Strategic Pilot');
}
if (bindingBlock.includes("next: 'strategic-pilot'")) {
  fail('effective-is-not-binding next step is the Field Manual');
}
if (!stepBlock('posted-is-not-effective').includes("'effective-is-not-binding'")) {
  fail('posted-is-not-effective related reading must point forward to effective-is-not-binding');
}

if (
  !effectivePage.includes('The series continues with') ||
  !effectivePage.includes('/insights/effective-is-not-binding')
) {
  fail('posted-is-not-effective must point the series forward to effective-is-not-binding');
}




const enforcedPageRequired = [
  ...bindingPageRequired,
  "Binding Is Not Enforced",
  "Binding is not enforced",
  "under that same named instrument / governing law for that channel, those binding obligations are actually being enforced against the named parties for the named scope",
  "not the existence of binding alone, not \"they’re bound so they’ll comply,\" not a dashboard green, not a CMMS checkbox, and not treating binding as automatic enforcement",
  "A firm can be binding and still not enforced",
  "instrument-required bind evidence exists while required demand/default/remedy/enforcement evidence is missing",
  "A firm can chase enforcement theater and still not be binding",
  "we’re enforcing / in default / collecting",
  "Binding evidence alone is not enforcement",
  "An enforcement claim alone is not proof of named binding under the effective filing trail",
  ...
  "does not collapse into Executed Is Not Closed",
  "does not rewrite Executed Is Not Closed",
  "named demand/default/remedy/enforcement actions under that instrument for those binding obligations",
  "practice record that says binding is enforced",
  "binding as enforced",
  "separates instrument-required bind mechanics from",
  ...
  "Evidence from the plant beats the enforcement claim when the claim is being used as proof of named binding under the effective filing trail",
  ...
  "Keep effective from Effective Is Not Binding, posted from Posted Is Not Effective, accepted from Accepted Is Not Posted, filed from Filed Is Not Accepted, audited from Audited Is Not Filed, and reported from Reported Is Not Audited, distinct from binding and from enforced.",
  "False confidence here is binding evidence treated as enforcement, or an enforcement claim treated as proof of named binding under the effective filing trail.",
  "demand or default notices delivered, cure periods started and tracked, default or acceleration declarations, remedy elections exercised, security enforcement steps taken, court/arbitral filings commenced, or other named enforcement actions",
];
const enforcedPage = read('app/insights/binding-is-not-enforced/page.tsx');
for (const required of enforcedPageRequired) {
  if (!enforcedPage.includes(required)) {
    fail(`binding-is-not-enforced page must include ${required}`);
  }
}

const enforcedBlock = stepBlock('binding-is-not-enforced');
for (const required of ['effective-is-not-binding', 'posted-is-not-effective', 'accepted-is-not-posted', 'filed-is-not-accepted', 'audited-is-not-filed', 'reported-is-not-audited', 'recognized-is-not-reported', 'collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!enforcedBlock.includes(`'${required}'`)) {
    fail(`binding-is-not-enforced related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(enforcedBlock)) {
  fail('binding-is-not-enforced related reading must include the Strategic Pilot');
}
if (enforcedBlock.includes("next: 'strategic-pilot'")) {
  fail('binding-is-not-enforced next step is the Field Manual');
}
if (!stepBlock('effective-is-not-binding').includes("'binding-is-not-enforced'")) {
  fail('effective-is-not-binding related reading must point forward to binding-is-not-enforced');
}

if (
  !bindingPage.includes('The series continues with') ||
  !bindingPage.includes('/insights/binding-is-not-enforced')
) {
  fail('effective-is-not-binding must point the series forward to binding-is-not-enforced');
}



const remediatedPageRequired = [
  ...enforcedPageRequired,
  "Enforced Is Not Remediated",
  "Enforced is not remediated",
  "the named breach / default / noncompliance that drove those enforcement actions has actually been cured or remedied for the named scope",
  "not the start of enforcement alone, not \"we sent a demand so it’s fixed,\" not a dashboard green, not a CMMS checkbox, and not treating an open enforcement file as automatic cure",
  "A firm can be enforced and still not remediated",
  "demand/default/remedy steps exist while required cure/remedy completion evidence is missing",
  "A firm can claim remediation theater and still not be enforced",
  "we’re cured / reinstated / current",
  "Enforcement evidence alone is not remediation",
  "A remediation claim alone is not proof of named enforcement under the binding trail",
  ...
  "Sync does not measure remediated",
  "Sync does not measure remediated for the customer",
  "Sync does not measure enforced or remediated for the customer",
  "Sync may surface an enforcement record or a remediation record",
  "does not collapse remediated into enforced",
  "does not collapse enforced into remediated",
  ...
  "does not collapse into Closed Is Not Resolved",
  "does not rewrite Closed Is Not Resolved",
  "instrument-required cure/remedy completion evidence for the named breach/default that drove those enforcement actions",
  "practice record that says enforced is remediated",
  "enforced as remediated",
  "separates named demand, default, remedy, and enforcement actions from",
  "/insights/binding-is-not-enforced",
  "Evidence from the plant beats the enforcement record when the record is being used as remediated",
  "Evidence from the plant beats the remediation claim when the claim is being used as proof of named enforcement under the binding trail",
  "treat enforced as remediated as Learning credit",
  "Sync refuses to pretend enforced or remediated is a status light",
  "Sync does not deem remediated for the customer",
  "Sync must not auto-deem-remediated",
  "Keep binding from Binding Is Not Enforced, effective from Effective Is Not Binding, posted from Posted Is Not Effective, accepted from Accepted Is Not Posted, filed from Filed Is Not Accepted, audited from Audited Is Not Filed, and reported from Reported Is Not Audited, distinct from enforced and from remediated.",
  "False confidence here is enforcement evidence treated as remediation, or a remediation claim treated as proof of named enforcement under the binding trail.",
  "cure notices accepted, cure consideration received and applied, reinstatement or waiver executed when the instrument requires it, restored collateral or coverage confirmed, dismissal/withdrawal of named enforcement steps when that is the cure path, or other named remediation completion evidence",
];
const remediatedPage = read('app/insights/enforced-is-not-remediated/page.tsx');
for (const required of remediatedPageRequired) {
  if (!remediatedPage.includes(required)) {
    fail(`enforced-is-not-remediated page must include ${required}`);
  }
}

const remediatedBlock = stepBlock('enforced-is-not-remediated');
for (const required of ['binding-is-not-enforced', 'effective-is-not-binding', 'posted-is-not-effective', 'accepted-is-not-posted', 'filed-is-not-accepted', 'audited-is-not-filed', 'reported-is-not-audited', 'recognized-is-not-reported', 'collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!remediatedBlock.includes(`'${required}'`)) {
    fail(`enforced-is-not-remediated related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(remediatedBlock)) {
  fail('enforced-is-not-remediated related reading must include the Strategic Pilot');
}
if (remediatedBlock.includes("next: 'strategic-pilot'")) {
  fail('enforced-is-not-remediated next step is the Field Manual');
}
if (!stepBlock('binding-is-not-enforced').includes("'enforced-is-not-remediated'")) {
  fail('binding-is-not-enforced related reading must point forward to enforced-is-not-remediated');
}

if (
  !enforcedPage.includes('The series continues with') ||
  !enforcedPage.includes('/insights/enforced-is-not-remediated')
) {
...
const recordedPageRequired = [
  ...releasedPageRequired,
  "Released Is Not Recorded",
  "Released is not recorded",
  "that executed release / waiver / discharge has actually been recorded / lodged / registered on the named public registry or instrument-required record of title for that channel",
  "not the executed release alone, not \"we signed so it’s on the registry,\" not an internal share link, not a draft upload in a private folder, not a dashboard green, not a CMMS checkbox, and not treating release theater as automatic public or registry record",
  "A firm can be released and still not recorded",
  "executed release/waiver/discharge exists while required registry/recording evidence is missing",
  "A firm can claim recording theater and still not be released",
  "it’s recorded / registered / on file",
  "Release evidence alone is not recording",
  "A recording claim alone is not proof of named release under the remediation trail",
  ...
  "does not collapse recorded into posted",
  "does not collapse posted into recorded",
  "does not collapse into Posted Is Not Effective",
  "does not rewrite Posted Is Not Effective",
  ...
  "does not collapse into Closure Is Not Complete",
  "does not rewrite Closure Is Not Complete",
  "instrument-required registry/recording/registration completion evidence for that executed release on the named record of title / public registry for that channel",
  "practice record that says released is recorded",
  "released as recorded",
  "separates instrument-required release, waiver, or discharge from",
  ...
  "Evidence from the plant beats the recording claim when the claim is being used as proof of named release under the remediation trail",
  ...
  "Keep remediated from Remediated Is Not Released, enforced from Enforced Is Not Remediated, binding from Binding Is Not Enforced, effective from Effective Is Not Binding, posted from Posted Is Not Effective, accepted from Accepted Is Not Posted, filed from Filed Is Not Accepted, audited from Audited Is Not Filed, and reported from Reported Is Not Audited, distinct from released and from recorded.",
  "False confidence here is release evidence treated as recording, or a recording claim treated as proof of named release under the remediation trail.",
  "PPSA/UCC financing-statement amendment or discharge filing, land-titles caveat discharge, SEDAR+/EDGAR disclosure of the release when the channel requires it, board minutes repository entry, lender portal public packet update, or other named recording/registration completion evidence",
  "Posted is public disclosure posting of an accepted filing pack",
  "Recorded here is recording of a release, waiver, or discharge against the named security or instrument record",
];
const recordedPage = read('app/insights/released-is-not-recorded/page.tsx');
for (const required of recordedPageRequired) {
  if (!recordedPage.includes(required)) {
    fail(`released-is-not-recorded page must include ${required}`);
  }
}

const recordedBlock = stepBlock('released-is-not-recorded');
for (const required of ['remediated-is-not-released', 'enforced-is-not-remediated', 'binding-is-not-enforced', 'effective-is-not-binding', 'posted-is-not-effective', 'accepted-is-not-posted', 'filed-is-not-accepted', 'audited-is-not-filed', 'reported-is-not-audited', 'recognized-is-not-reported', 'collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!recordedBlock.includes(`'${required}'`)) {
    fail(`released-is-not-recorded related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(recordedBlock)) {
  fail('released-is-not-recorded related reading must include the Strategic Pilot');
}
if (recordedBlock.includes("next: 'strategic-pilot'")) {
  fail('released-is-not-recorded next step is the Field Manual');
}
if (!stepBlock('remediated-is-not-released').includes("'released-is-not-recorded'")) {
  fail('remediated-is-not-released related reading must point forward to released-is-not-recorded');
}

if (
  !releasedPage.includes('The series continues with') ||
  !releasedPage.includes('/insights/released-is-not-recorded')
) {
  fail('remediated-is-not-released must point the series forward to released-is-not-recorded');
}




const recordedClearancePageRequired = [
  ...recordedPageRequired,
  "Recorded Is Not Cleared",
  "Recorded is not cleared",
  "the named encumbrance / obligation / claim that was released and recorded has actually been cleared from the operating title, search position, and counterparty books for the named scope",
  "not the recording alone, not \"it’s filed so title is clear,\" not a dashboard green, not a CMMS checkbox, and not treating registry theater as automatic operating clearance",
  "A firm can be recorded and still not cleared",
  "registry/recording evidence exists while required operating title/search/counterparty clearance trail is missing",
  "A firm can claim clearance theater and still not be recorded",
  "title is clear / the hold is gone",
  "Recording evidence alone is not clearance",
  "A clearance claim alone is not proof of named recording under the release trail",
  ...
  "does not collapse this cleared into Cleared Is Not Complete",
  "does not collapse this cleared into Ready Is Not Cleared",
  "does not rewrite Cleared Is Not Complete",
  "does not rewrite Ready Is Not Cleared",
  "does not collapse into Released Is Not Recorded",
  "does not rewrite Released Is Not Recorded",
  "instrument-required operating title/search/counterparty clearance completion evidence for that named encumbrance/obligation after the recording",
  "practice record that says recorded is cleared",
  "recorded as cleared",
  "separates instrument-required registry, recording, or registration completion from",
  ...
  "Evidence from the plant beats the clearance claim when the claim is being used as proof of named recording under the release trail",
  ...
  "Keep released from Released Is Not Recorded, remediated from Remediated Is Not Released, enforced from Enforced Is Not Remediated, binding from Binding Is Not Enforced, effective from Effective Is Not Binding, posted from Posted Is Not Effective, accepted from Accepted Is Not Posted, filed from Filed Is Not Accepted, audited from Audited Is Not Filed, and reported from Reported Is Not Audited, distinct from recorded and from cleared.",
  "False confidence here is recording evidence treated as clearance, or a clearance claim treated as proof of named recording under the release trail.",
  "title or PPSA/UCC search returning clear for that named interest, lender or secured-party system showing discharged/released with no residual hold, board or obligation register updated to clear, escrow/closing checklist item closed against the recording evidence, or other named clearance completion evidence",
  "This cleared is not the cleared flag in Cleared Is Not Complete",
];
const recordedClearancePage = read('app/insights/recorded-is-not-cleared/page.tsx');
for (const required of recordedClearancePageRequired) {
  if (!recordedClearancePage.includes(required)) {
    fail(`recorded-is-not-cleared page must include ${required}`);
  }
}

const recordedClearanceBlock = stepBlock('recorded-is-not-cleared');
for (const required of ['released-is-not-recorded', 'remediated-is-not-released', 'enforced-is-not-remediated', 'binding-is-not-enforced', 'effective-is-not-binding', 'posted-is-not-effective', 'accepted-is-not-posted', 'filed-is-not-accepted', 'audited-is-not-filed', 'reported-is-not-audited', 'recognized-is-not-reported', 'collected-is-not-recognized', 'closed-is-not-collected', 'reconciled-is-not-closed', 'booked-is-not-reconciled', 'settled-is-not-booked', 'paid-is-not-settled', 'covered-is-not-paid', 'insured-is-not-covered', 'certified-is-not-insured', 'assured-is-not-certified', 'recoverable-is-not-assured', 'rehearsed-is-not-recoverable', 'transferable-is-not-rehearsed', 'governed-is-not-transferable', 'owned-is-not-governed', 'compounded-is-not-owned', 'scaled-is-not-compounded', 'sustained-is-not-scaled', 'adopted-is-not-sustained', 'trusted-is-not-adopted', 'proven-is-not-trusted', 'resolved-is-not-proven', 'closed-is-not-resolved', 'executed-is-not-closed', 'authorized-is-not-executed', 'verified-is-not-authorized', 'accepted-is-not-verified', 'complete-is-not-accepted', 'action-is-not-execution', 'simulation-is-not-proof', ...acceptedReadingRequired]) {
  if (!recordedClearanceBlock.includes(`'${required}'`)) {
    fail(`recorded-is-not-cleared related reading must cite ${required}`);
  }
}
if (!/includePilot:\s*true/.test(recordedClearanceBlock)) {
  fail('recorded-is-not-cleared related reading must include the Strategic Pilot');
}
if (recordedClearanceBlock.includes("next: 'strategic-pilot'")) {
  fail('recorded-is-not-cleared next step is the Field Manual');
}
if (!stepBlock('released-is-not-recorded').includes("'recorded-is-not-cleared'")) {
  fail('released-is-not-recorded related reading must point forward to recorded-is-not-cleared');
}

if (
  !recordedPage.includes('The series continues with') ||
  !recordedPage.includes('/insights/recorded-is-not-cleared')
) {
