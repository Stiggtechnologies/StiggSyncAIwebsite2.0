        ...
        >
          ...
          <div className="text-gray-300 space-y-6">
            ...
            <p>
              ...
              states the split after the cash balance. Cash that can be spent now is not how long
              operations can continue at the current net burn.
            </p>
            ...
            <p>
              ...
              states the split after the runway figure. A named owner is not survival. Meeting
              obligations through the next decision horizon is a separate record.
            </p>
            ...
            <p>
              ...
              states the split after survival. A named owner is not solvency. Meeting obligations
              through the next decision horizon is not whether assets and claims can cover
              liabilities over a structural horizon.
            </p>
            ...
            <p>
              ...
              states the split after solvency. A named owner is not liquidity. Assets and claims
              that cover liabilities over a structural horizon are not whether cash and near-cash
              meet the near-term windows.
            </p>
            ...
            <p>
              ...
              states the split after liquidity. A named owner is not flexibility. Cash and near-cash
              that meet the near-term windows are not whether the firm can reallocate inside a named
              decision window.
            </p>
            ...
            <p>
              ...
              states the split after flexibility. A named owner is not optionality. The ability to
              reallocate inside a named decision window is not unused rights, capacity lines, budget
              envelopes, or contractual choices on paper.
            </p>
            ...
            <p>
              ...
              states the split after optionality. A named owner is not strategy. Unused rights,
              capacity lines, budget envelopes, or contractual choices on paper are not a named
              choice among alternatives the firm is committing to execute.
            </p>
            ...
            <p>
              ...
              states the split after strategy. A named owner is not execution. A committed path and
              resource allocation are not work completed inside the named decision window.
            </p>
            ...
            <p>
              ...
              states the split after execution. A named owner is not results. Work completed inside
              the named decision window is not the attributed, measured change in plant capacity,
              risk, cost, or production under a named measurement window.
            </p>
            ...
            <p>
              ...
              states the split after results. A named owner is not learning. An attributed measured
              change under a named measurement window is not an updated decision rule the firm adopts
            ...
            <p>
              ...
              states the split after learning. A named owner is not judgment. An updated decision
              rule under a named decision window is not the situated call that commits plant work,
              capital, or risk now.
            </p>
