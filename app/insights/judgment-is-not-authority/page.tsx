...
const article = getInsightArticle('judgment-is-not-authority');

export default function JudgmentIsNotAuthorityPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-32 max-w-4xl">
        ...
        >
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Judgment Is Not Authority</h1>
            {article?.author ? (
          ...
          <div className="text-gray-300 space-y-6">
            <p className="text-xl font-semibold text-white">
              Judgment is not authority. Judgment is the situated call under incomplete information
              ...
              authority. Sync does not measure authority for the customer. Sync does not collect
            ...
            <p>
              ...
              Learning is not judgment. Judgment is not authority. Each word can be true in its own
            ...
            <p>
              ...
              . This essay is why judgment cannot be read as authority. The{' '}
              <Link
              ...
              essay definition of judgment, and it is not this essay definition of authority. None of
              those steps shows authority. None of them treats judgment as authority. None of them
              measures judgment for the customer. None of them measures authority for the customer.
              None of them attributes cash, risk, or capacity. None of them binds the firm for the
              customer.
            </p>

            <h2 className="text-3xl font-bold text-white mt-12 mb-6">
              A situated call is not the right to bind
            </h2>
            ...
            <p>
              ...
              sits one step earlier. Learning is an updated decision rule, model, or operating
              ...
              essay starts after that split has been kept. Learning is not judgment. The next refusal
              is that judgment is not authority. The call can be on the record under the named
            ...
            <p>
              ...
              learning. The learning is not judgment. The judgment is not authority. An attributed
            ...
            <p>
              ...
              learning. The learning is not judgment. The judgment is not authority. Completed work
            ...
            <p>
              ...
              not learning. The learning is not judgment. The judgment is not authority. A committed
            ...
            <p>
              ...
              judgment. The judgment is not authority. Unused rights on paper are not decision rights
            ...
            <p>
              ...
              The learning is not judgment. The judgment is not authority. The ability to change
            ...
            <p>
              ...
              The judgment is not authority. Cash and near-cash that meet the near-term windows are
              not authority.
            </p>
            ...
            <p>
              ...
              not learning. The learning is not judgment. The judgment is not authority. Balance-sheet
            ...
            <p>
              ...
              execution is not results. The results are not learning. The learning is not judgment.
              The judgment is not authority. Obligation continuity through the next decision horizon
            ...
            <p>
              ...
              strategy is not execution. The execution is not results. The results are not learning.
              The learning is not judgment. The judgment is not authority. A duration at the current
            ...
            <p>
              ...
              not judgment. The judgment is not authority. Money received that can be spent now is
            ...
            <p>
              ...
              optionality. The optionality is not strategy. The strategy is not execution. The
              execution is not results. The results are not learning. The learning is not judgment.
              The judgment is not authority. An annualized contract is not authority.
            </p>
            ...
            <p>
              ...
              flexibility. The flexibility is not optionality. The optionality is not strategy. The
              strategy is not execution. The execution is not results. The results are not learning.
              The learning is not judgment. The judgment is not authority. A period booking is not
            ...
            <p>
              ...
              optionality. The optionality is not strategy. The strategy is not execution. The
              execution is not results. The results are not learning. The learning is not judgment.
              The judgment is not authority. An attributed change in cash, risk, or capacity is not,
            ...
            <p>
              ...
              learning. The learning is not judgment. The judgment is not authority. This essay does
            ...
            <p>
              ...
              flexibility. The flexibility is not optionality. The optionality is not strategy. The
              strategy is not execution. The execution is not results. The results are not learning.
              The learning is not judgment. The judgment is not authority. This essay does not rewrite
            ...
            <p>
              ...
              optionality. Optionality is not strategy. Strategy is not execution. Execution is not
              results. Results is not learning. Learning is not judgment. Judgment is not authority.
            ...
            <p>
              ...
              as judgment. An authority note alone proves neither.
            </p>
            ...
            <p>
              ...
              Results is still not learning. Learning is still not judgment. Judgment is still not
              authority. Margin is not profit. Profit is not value. A shutdown can collect cash, show
            ...
            <h2 className="text-3xl font-bold text-white mt-12 mb-6">
              Authority is the formal, named right to bind
            </h2>
            ...
            <p>
              ...
              is not a green. An authority note is not a green. A title without scope is not a green.
            ...
            <h2 className="text-3xl font-bold text-white mt-12 mb-6">
              A firm with judgment can still lack authority, and a firm with authority can still lack
              judgment
            </h2>
            ...
            <p>
              ...
              judgment. Judgment is not authority.
            </p>
            ...
            <p>
              ...
              green. A judgment note is not a green. An authority note is not a green. A title
            ...
            <p>
              ...
              precision. Sync refuses when evidence is insufficient. Sync does not measure authority.
              Sync does not measure authority for the customer. Sync does not measure judgment. Sync
            ...
            <h2 className="text-3xl font-bold text-white mt-12 mb-6">
              Surfacing a judgment note or an authority note is still a read
            </h2>
            ...
            <p>
              ...
              measure judgment. Sync does not measure authority. Sync does not collect cash.
            </p>
            ...
            <p>
              ...
              measures authority, measures authority for the customer, collects cash, or attributes a
            ...
            <div className="bg-gradient-to-b from-[#3B82F6]/10 to-transparent border border-[#3B82F6]/30 rounded-2xl p-8 my-12">
              ...
              <p className="text-gray-400 mb-6">
                ...
                measures authority for the customer, collects cash, attributes cash, risk, or
          ...
          <InsightNextSteps slug="judgment-is-not-authority" />
        </motion.article>
      </div>
    </main>
  );
