...
async function createCampaign() {
  ...
  console.log(`✓ Created campaign: AIM - Search - Lead Generation - Feb 2026 (ID: ${campaignId})\n`);
  return campaignId;
}
...
async function main() {
  ...
  console.log('Account:', config.customer_id);
  console.log('');
  ...
  try {
    ...
    console.log(`\nView campaign: https://ads.google.com/aw/campaigns?campaignId=${campaignId}&ocid=${config.customer_id}`);
